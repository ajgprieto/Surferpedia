...
public class Global extends GlobalSettings {
  ...
  public void onStart(Application app) {
    ...
    UserInfoDB.addUserInfo("John Smith", adminEmail, adminPassword);
      ...
      SurferDB
          .addSurfer(new SurferFormData(
              ...
              "Kolohe Andino (born March 22, 1994 in San Clemente, California) is an American surfer. He began to surf "
                  ...
                  + " of Surfing[1] and the Vans Pier"
                  + "Classic world tour events, 2011. "
                  + "Andino's sponsors include Oakley eyewear and Hurley wetsuits and clothing.",
      ...
      SurferDB
          .addSurfer(new SurferFormData(
              ...
              "At eighteen, Kelia is one of the most graceful, carefree, and above all, versatile surfers out there. "
                  ...
                  + "whether she's longboarding or shortboarding."
                  + " Kelia makes surfing look fun to surfers and "
      ...
      SurferDB
          .addSurfer(new SurferFormData(
              ...
              "Noa Patrick Kaiuluokealaula Mizuno was born on December 6th 1998. At 5'5, 120 lbs he attends Punahou on"
                  ...
                  + "He loves good surfing & good times and hates losing.",
