...
/**
 * Initialization for the application. will have three surfer's bios.
 * 
 * @author scotthonda
 * 
 */
public class Global extends GlobalSettings {
  ...
  public void onStart(Application app) {
   ...
   if (!UserInfoDB.isUser(user)) {
     UserInfoDB.addUserInfo("User", user, password);
   }
    ...
    if (SurferDB.getSurfers().isEmpty()) {
      SurferDB.addSurfer(new SurferFormData("Kolohe Andino", "San Clemente, California", "",
          ...
          "Kolohe Andino (born March 22, 1994 in San Clemente, California) is an American surfer. He began to surf "
              + "at age 10 and holds the record for the most "
              + "National Scholastic Surfing Association championships won by a"
              + "male competitor (9) . He won both the ASP 6-Star Quicksilver Brazil Open"
              + " of Surfing[1] and the Vans Pier" + "Classic world tour events, 2011. "
              + "Andino's sponsors include Oakley eyewear and Hurley wetsuits and clothing.", "koloheandino", "Male",
          "Regular", "United States"));

      SurferDB.addSurfer(new SurferFormData("Kelia Moniz", "Waikiki, Hawaii", "",
          "http://b.vimeocdn.com/ts/301/108/301108760_640.jpg", "http://b.vimeocdn.com/ts/301/108/301108760_640.jpg",
          "At eighteen, Kelia is one of the most graceful, carefree, and above all, versatile surfers out there. "
              + "She's equally fluid off the lip or cross-stepping to the nose, "
              + "whether she's longboarding or shortboarding." + " Kelia makes surfing look fun to surfers and "
              + "non-surfers alike with her flow, and her mother compares "
              + "her surfing style to that of a sassy ballerina.", "keliamoniz", "Female", "Regular", "United States"));

      SurferDB
          .addSurfer(new SurferFormData("Noa Mizuno", "Honolulu, Hawaii", "",
              ...
              "Noa Patrick Kaiuluokealaula Mizuno was born on December 6th 1998. At 5'5, 120 lbs he attends Punahou on"
                  + " Oahu, Hawai'i. His favourite surf spot is Pipelines. "
                  + "He loves good surfing & good times and hates losing.", "noamizuno", "Grom", "Regular",
              "United States"));
    }
  }
}