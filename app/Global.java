...
public class Global extends GlobalSettings {
  ...
  public void onStart(Application app) {
    ...
    SurferDB.add(new SurferFormData(new Surfer("Rabbit Kekai", "Honolulu, HI", "A winner of the Peruvian "
        ...
        "http://www.surfersvillage.com/img/news/1009-mr_albert-rabbit-kekai.jpg", "From Waikiki beach boys to groundbreaking surfer"+ "to North Shore Beach Marshall, Rabbit Kekai has crossed"+
        ...
        "as an army frogman in the South Pacific. He was one of four from his 12-man platoon to return from action." +"A winner of the Peruvian and Makaha International titles during the '50s, Rabbit competed worldwide and"+
        ...
        "back to earth.\"-- Jason Borte",        
        "rabbitkekai", "Male")));
    
    SurferDB.add(new SurferFormData(new Surfer("Pauline Menczer", "Sydney, Australia","2002 ASP World Qualifying Series", "http://www.surfersvillage.com/img/news/menczer_fiji_tostee_2.jpg" ,"http://www.surfline.com/surfaz/images/menczer_pauline/pf_pmenzer_port.jpg",  
"One of pro surfing's great individuals, Pauline Menzcer won the 1988 world amateur and 1993 professional"+
    ...
    SurferDB.add(new SurferFormData(new Surfer("John Mel", "Santa Cruz, CA", "Three National Titles", "http://www.ocinsite.com/images/uploads/John.jpg","http://www.norcalsurfers.com/word/wp-content/gallery/rider-john-mel/quiksilver-troyer-copy.jpg", "John Mel was born and raised in the coastal town of Santa Cruz, California into a surfing legacy under his"+
      ...
      "John is also an endorsed athlete who represents his sponsors with esteem in catalogs, e-commerce,"+
        "ad-campaigns and in the pages of surf magazines and websites. Along with his surfing, John is very well spoken"+        "and loves to give a good interview. Many find his prolific YouTube clips to be entertaining and uplifting."+
      ...
      "John's true love is traveling the world in search of the perfect wave. From Europe to Fiji and Mexico to"+
        "South America, there is no stopping this young athlete from chasing his dreams.", "johnmel", "Grom")));
